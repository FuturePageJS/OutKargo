...
exports.save = (req, resp)=>{
    ...
    conexion.query('INSERT INTO operador SET ?', {
        Nombre1:Nombre1,
        Nombre2:Nombre2,
        Apellido1:Apellido1,
        Apellido2:Apellido2,        
            ...
            conexion.query('UPDATE usuarios SET ? WHERE  ID=?',[{
               ...
               Cargo:Cargo
                ...
                if(error){
                    ...
                    resp.redirect('/Supervisor/Operador/');
                }
            })
        }
    })
...
exports.update = (req, resp)=>{
    ...
    const Telefono = req.body.Telefono;
    const ID_Usuario = req.body.ID_Usuario;
    conexion.query('UPDATE operador SET ? WHERE ID=?', [{
        Nombre1:Nombre1,
        Nombre2:Nombre2,
        Apellido1:Apellido1,
        Apellido2:Apellido2,        
