...
exports.save = (req, resp)=>{
    ...
    const ID_ListaEC = req.body.ID_ListaEC;
    //Fecha y hora
    ...
    if (HorometroF == "") {
        conexion.query('INSERT INTO listaec SET ?',{
            ...
            if(error){ 
                resp.render('Operador/',{
                    ...
                    alertMessage: "¡La lista de chequeo perteneciente a Electrica Contrabalanceada!",
                    alertIcon: "error",
                ...
                if (Mantenimiento == 3) {
                    ...
                    if (ConsecutivoCondiciones == "" && DescripcionCondiciones == "") {
                        ...
                        //Si llenan solicitud pero no condiciones
                            ...
                            conexion.query('INSERT INTO reportedesolicitudec SET ?', {
                                Fecha:FechaCompleta,
                                ID_Consecutivo:ConsecutivoSolicitud,
                                Descripcion:DescripcionSolicitud,
                                ID_ListaEC:ID_ListaEC
                            },(error, results)=>{
                                if(error){
                                    console.log(error)
                                }else{
                    ...
                    //Si llenan condiciones
                        ...
                        conexion.query('INSERT INTO reportedecondicionesec SET ?', {
                            Fecha:FechaCompleta,
        ...
        if (! HorometroF == "") {
            ...
            //Si el horometro final es mayor que el horometro inicial
                ...
                //Si el horometro final es menor al permitido 
                    ...
                    if(HorometroI < HorometroF <= HorometroVa){
                        conexion.query('UPDATE listaec SET ? WHERE ID=?',[{
                            HorometroF:HorometroF,
                            Estado:Estado,
                            EstadoV:EstadoV,
                            EstadoF:EstadoF,
