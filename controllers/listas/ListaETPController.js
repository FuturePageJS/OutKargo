...
exports.save = (req, resp)=>{
    ...
    const Estado_General_Ruedas_De_Carga = req.body.Estado_General_Ruedas_De_Carga;
    const Estado_General_Rueda_Motriz = req.body.Estado_General_Rueda_Motriz;
    ...
    const Extintor_De_Incendios_Estado = req.body.Extintor_De_Incendios_Estado;
    ...
    const Protector_Superior = req.body.Protector_Superior;
    const Reflector = req.body.Reflector;
    const Linea_De_Sujecion = req.body.Linea_De_Sujecion;
    const Arnes_De_Seguridad = req.body.Arnes_De_Seguridad;
    const Plataforma_Del_Operador_Y_Horquillas = req.body.Plataforma_Del_Operador_Y_Horquillas; 
    const Paleta_De_Sujecion_Y_Palanca_De_Liberacion = req.body.Paleta_De_Sujecion_Y_Palanca_De_Liberacion;
    const Interruptor_De_Pie = req.body.Interruptor_De_Pie;
    const Mastil = req.body.Mastil;
    const Consola_Del_Operador = req.body.Consola_Del_Operador;
    const Manija_Manual_De_Valvula_De_Descanso = req.body.Manija_Manual_De_Valvula_De_Descanso;
    ...
    const Estado_General_Del_Dispositivo_Pararetirar_La_Bateria = req.body.Estado_General_Del_Dispositivo_Pararetirar_La_Bateria;
    ...
    const ID_ListaETP = req.body.ID_ListaETP;
    //Fecha y hora
    ...
    if (HorometroF == "") {
        conexion.query('INSERT INTO listaetp SET ?',{
            ...
            if(error){
                resp.render('Operador/',{
                    ...
                    alertMessage: "¡La lista de chequeo perteneciente a Electrica, Toma pedido",
                    alertIcon: "error",
                ...
                if (Mantenimiento == 3) {
                    ...
                    if (ConsecutivoCondiciones == "" && DescripcionCondiciones == "") {
                        ...
                        //Si llenan solicitud pero no condiciones
                            ...
                            conexion.query('INSERT INTO reportedesolicitudetp SET ?', {
                                Fecha:FechaCompleta,
                                ID_Consecutivo:ConsecutivoSolicitud,
                                Descripcion:DescripcionSolicitud,
                                ID_ListaETP:ID_ListaETP
                            },(error, results)=>{
                                if(error){
                                    console.log(error)
                                }else{
                    ...
                    //Si llenan condiciones
                        ...
                        conexion.query('INSERT INTO reportedecondicionesetp SET ?', {
                            Fecha:FechaCompleta,
        ...
        if (! HorometroF == "") {
            ...
            //Si el horometro final es mayor que el horometro inicial
                ...
                //Si el horometro final es menor al permitido 
                    ...
                    if(HorometroI < HorometroF <= HorometroVa){
                        conexion.query('UPDATE listaetp SET ? WHERE ID=?',[{
                            HorometroF:HorometroF,
                            Estado:Estado,
                            EstadoV:EstadoV,
                            EstadoF:EstadoF,
